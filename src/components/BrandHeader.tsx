...
export const BrandHeader: React.FC<BrandHeaderProps> = ({ subtitle }) => {
	return (
		<>
			...
			<span className="text-5xl font-black mb-2 bg-gradient-to-r from-primary via-primary/70 to-primary bg-clip-text text-transparent animate-gradient tracking-tight">
				Sudoques
			</span>
			{subtitle && (
