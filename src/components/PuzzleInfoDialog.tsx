	...
	return (
		<>
			<button
				...
				className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-secondary border border-border text-muted-foreground hover:text-primary hover:bg-accent transition-all text-sm group"
			>
				<Info size={20} />
